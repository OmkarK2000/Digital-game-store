...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($select_user) > 0) {
        ...
        if ($pass != $cpass) {
            ...
            users (name, email, password, user_type) VALUES('$name', '$email', '$cpass', '$user_type') ");
...
<body>
    ...
    ?>
        ...
        <h2 class="form-label mt-4 text-center">Register here</h2>
        <form action="#" method="post">
            ...
            <div class="mb-3 text-center">
                <select name="user_type" class="form-label">
                ...
                <p class="form-label">already have an account? <a href="login.php">login now</a></p>
            </div>
